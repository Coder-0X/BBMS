...
-- The actual, authoritative schema is generated by Django from
-- donors/models.py, inventory/models.py, lab/models.py, and
-- patients/models.py via:
--   python manage.py migrate
-- Django's real table names are prefixed by app (e.g. donors_donor,
-- inventory_bloodunit), not the bare names used below.
